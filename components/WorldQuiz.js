...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 16, color: '#3B82F6', fontWeight: '600', marginLeft: 8 },
  ...
  scoreNumber: { fontSize: 48, fontWeight: 'bold', color: '#3B82F6', marginVertical: 8 },
  percentageText: { fontSize: 24, fontWeight: '600', color: '#10B981' },
  resetButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#3B82F6', paddingVertical: 16, paddingHorizontal: 32, borderRadius: 16, gap: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
