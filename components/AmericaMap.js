    ...
    >
      ...
      <View style={styles.mapContainer} onLayout={onMapLayout}>
        <Animated.View style={[styles.mapWrapper, { transform: [{ scale }, { translateX }, { translateY }] }]} {...panResponder.panHandlers}>
          {hasLayout && (
          <Svg width={mapW} height={mapH} viewBox={continentViewBox.america.viewBox} preserveAspectRatio={continentViewBox.america.preserveAspectRatio} style={styles.svg}>
            ...
            <G>
              ...
              .map((country) => {
                ...
                const americaIndex = isAmerica ? americaCountries.indexOf(country.id) : 0;
                let fillColor = isAmerica ? getCountryColor(americaIndex) : '#475569';
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  header: { paddingTop: 24, paddingBottom: 4, paddingHorizontal: 8, backgroundColor: 'rgba(15, 23, 42, 0.92)', borderBottomWidth: 1, borderBottomColor: 'rgba(148, 163, 184, 0.2)' },
